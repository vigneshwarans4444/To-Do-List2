...
// Account Avatar component for the chooser
  ...
  return (
    <div
      style={{
        ...
        height: size,
        borderRadius: '50%',
        background: photo ? 'transparent' : `linear-gradient(135deg, hsl(${hue},65%,50%), hsl(${(hue + 60) % 360},70%,40%))`,
        display: 'flex',
        alignItems: 'center',
...
export default function LoginPage() {
  ...
  // Load already registered accounts from localStorage
      ...
      <div className={styles.loginCard}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.subtitle}>
            {googleStep === 'list' ? 'to continue to FlowTodo' : 'Use your Google Account'}
          </p>
        </div>
        ...
        <div className={styles.rightCol}>
          ...
          {googleStep === 'list' && (
            <div style={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'space-between' }}>
              <div className={styles.accountListContainer}>
                {registeredAccounts.map((acc) => (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      <AccountAvatar name={acc.name} photo={acc.photo} size={32} />
                ...
                >
                  <div style={{ width: 32, height: 32, borderRadius: '50%', backgroundColor: 'rgba(255, 255, 255, 0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <AccountAvatar name="" photo={null} size={16} />
                  </div>
              ...
              <div className={styles.actionsRow} style={{ justifyContent: 'flex-start' }}>
                {/* Info label or back button if needed */}
              </div>
            </div>
          )}
          ...
          {googleStep === 'input' && (
            <form onSubmit={handleCustomEmailSubmit} className={styles.formContainer} style={{ height: '100%', justifyContent: 'space-between' }}>
              <div>
